    ...
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full max-w-md h-[600px] overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 right-4 bg-card/90 backdrop-blur-sm rounded-xl p-3 border border-border shadow-lg">
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              <div className="w-8 h-8 rounded-lg bg-muted animate-pulse" />
              <div className="flex-1">
                <div className="h-2 w-20 bg-muted rounded animate-pulse" />
                <div className="h-2 w-32 bg-muted rounded mt-1 animate-pulse" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center justify-center gap-4">
            {[
              ...
              <button
                key={label}
                className="w-12 h-12 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-accent/20 hover:text-accent transition-colors"
              >
