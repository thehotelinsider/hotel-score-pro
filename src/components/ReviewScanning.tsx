    ...
    <div className="min-h-screen pt-20 px-4 pb-32">
      <div className="max-w-lg mx-auto space-y-4">
        {mockReviews.slice(0, visibleReviews).map((review, index) => (
          <div
            key={review.id}
            className="p-5 bg-card rounded-xl border border-border shadow-sm animate-slide-up"
            style={{ animationDelay: `${index * 100}ms` }}
          >
            <div className="flex items-start gap-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-muted to-secondary flex items-center justify-center flex-shrink-0 overflow-hidden">
                {review.avatar ? (
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-background via-background to-transparent">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center gap-3 text-foreground mb-3">
            ...
            <span className="font-medium">Scanning Google Reviews</span>
          </div>
